...
\begin{figure}[H]
    \centering
        ...
        \caption{Fidelity of the PCQCM plotted on the Bloch sphere. The Mollweide projection was used in order to represent the sphere in 2D.}
...
\begin{figure}[H]
    \begin{minipage}{.5\textwidth}
      ...
      \begin{minipage}{.5\textwidth}
        ...
        \caption{Fidelity of the PCEQCM plotted over the Bloch sphere. The Mollweide projection was used in order to represent the sphere in 2D.}
