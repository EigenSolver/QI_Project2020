...
\begin{quantikz}
    \lstick{$|0\rangle_{a_1}$} & \gate{R(\theta_1)}  & \swap{2}& \qw & \qw & \qw &\swap{2} &\gate{R(\theta_3)} & \targ{}&\qw&\ctrl{2}&\qw & \meter{}\\
    \lstick{} & \qw& \qw& \qw& \qw& \qw& \qw & \qw& \qw& \qw & \qw& \qw & \qw\\
    \lstick{$|\psi \rangle_{a_0}$}  & \qw & \targX{} & \ctrl{2} & \qw & \targ{} & \targX{} & \qw & \ctrl{-2} & \ctrl{2} & \targ{} & \targ{} & \qw \\
    \lstick{} & \qw& \qw& \qw& \qw& \qw& \qw & \qw& \qw& \qw & \qw& \qw & \qw\\
    \lstick{$|0\rangle_{b_1}$} & \qw & \qw & \targ{} & \gate{R(\theta_2)}  &\ctrl{-2} & \qw & \qw & \qw & \targ{} & \qw & \ctrl{-2} & \qw \\
\end{quantikz}.
