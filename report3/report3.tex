...
Given 2 qubits, with the first $B$ (Bob) to be the target and the second $E$ (Eve) to be the copy, a phase covariant economical quantum cloning machine \cite{PhysRevA.72.052322} for the $xz$ equator can be defined by
\begin{align*}
